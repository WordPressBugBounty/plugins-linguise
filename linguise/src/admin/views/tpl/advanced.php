...
$merged_dynamic_warning = sprintf(
    esc_html($translation_strings['dynamic']['warning_1']),
...
$merged_dynamic_warning .= '<br />' . esc_html($translation_strings['dynamic']['warning_2']);
...
<div class="tab-linguise-options">
    ...
    <div class="linguise-options full-width<?php echo $has_api_key ? '' : ' is-disabled'; ?>">
        ...
        <div class="flex flex-col mt-4 gap-2 linguise-inner-options">
            ...
            <?php echo \Linguise\WordPress\Admin\Helper::renderAdmonition($merged_dynamic_warning, 'warning', [ // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- pre sanitized
