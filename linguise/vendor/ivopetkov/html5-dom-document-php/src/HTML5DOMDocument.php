...
namespace Linguise\Vendor\IvoPetkov;

use Linguise\Vendor\IvoPetkov\HTML5DOMDocument\Internal\QuerySelectors;

/**
 * Represents a live (can be manipulated) representation of a HTML5 document.
 * 
 * @method \Linguise\Vendor\IvoPetkov\HTML5DOMElement|false createElement(string $localName, string $value = '') Create new element node.
 * @method \Linguise\Vendor\IvoPetkov\HTML5DOMElement|false createElementNS(?string $namespace, string $qualifiedName, string $value = '') Create new element node with an associated namespace.
...
class HTML5DOMDocument extends \DOMDocument
{
    ...
    public function __construct(string $version = '1.0', string $encoding = '')
    {
        ...
        $this->registerNodeClass('DOMElement', '\Linguise\Vendor\IvoPetkov\HTML5DOMElement');
    }
