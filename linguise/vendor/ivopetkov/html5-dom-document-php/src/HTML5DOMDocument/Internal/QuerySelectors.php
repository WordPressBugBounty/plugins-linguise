...
namespace Linguise\Vendor\IvoPetkov\HTML5DOMDocument\Internal;

use Linguise\Vendor\IvoPetkov\HTML5DOMElement;
...
trait QuerySelectors
{
    ...
    private function internalQuerySelectorAll(string $selector, $preferredLimit = null)
    {
        ...
        return new \Linguise\Vendor\IvoPetkov\HTML5DOMNodeList($result);
    }
}
