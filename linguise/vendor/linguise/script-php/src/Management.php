...
class Management {
     ...
     * @var array
     */
    public static $flag_options_map = [
    ...
    public function updateConfig()
    {
        ...
        if (isset($_POST['linguise_options'])) {
            ...
            $linguise_options = [
                ...
                'enable_flag' => Helper::boolInt($enable_flag),
                'enable_language_name' => Helper::boolInt($enable_language_name),
                'enable_language_name_popup' => Helper::boolInt($enable_language_name_popup),
                'enable_language_short_name' => Helper::boolInt($enable_language_short_name),
            ...
            if (!$queried_api && !empty($linguise_options['token'])) {
                ...
                $payload = [
                    ...
                    'dynamic_translations' => Helper::intBool($dynamic_translations['enabled']),
                    'language_settings' => [
                        // Flag related
                        'display' => $linguise_options['flag_display_type'],
                        'position' => $linguise_options['display_position'],
                        'enabled_flag' => Helper::intBool($enable_flag),
                        'enabled_lang_name' => Helper::intBool($enable_language_name),
                        'enabled_lang_name_popup' => Helper::intBool($enable_language_name_popup),
                        'enabled_lang_short_name' => Helper::intBool($enable_language_short_name),
    ...
    public function remoteUpdate()
    {
        ...
        if (!empty($input_data['language_settings'])) {
            foreach ($input_data['language_settings'] as $flag_key => $flag_value) {
                ...
                $options[$flag_real_key] = Helper::boolInt($flag_value);
            }
        }
